...
// FAQPage-JSON-LD wird statisch via Prerender ausgeliefert (scripts/prerender.mjs).
// Hier wird nur noch die sichtbare FAQ-UI gerendert – kein DOM-Schema-Inject mehr.
